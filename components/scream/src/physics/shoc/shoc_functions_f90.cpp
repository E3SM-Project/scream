...
void pblintd_surf_temp_f(Int shcol, Int nlev, Int nlevi, Real* z, Real* ustar, Real* obklen, Real* kbfs, Real* thv, Real* tlv, Real* pblh, bool* check, Real* rino)
{
  ...
  Kokkos::Array<view_2d, 3> views_2d;
  ekat::host_to_device({z, thv, rino}, shcol, nlev, views_2d, true);
  view_2d z_2d   (views_2d[0]),
          thv_2d (views_2d[1]),
          rino_2d(views_2d[2]);

  Kokkos::Array<view_1d, 5> views_1d;
...
//  Kokkos::Array<SHOC::view_1d<bool> > bviews_1d;
//  ekat::host_to_device({check}, shcol, bviews_1d);
//  SHOC::view_1d<bool> check_1d (bviews_1d[0]);  
  ...
  Kokkos::Array<view_1d, 2> out_1d_views = {pblh_1d, tlv_1d};
  ekat::device_to_host<int, 2>({pblh, tlv}, {shcol}, out_1d_views);
