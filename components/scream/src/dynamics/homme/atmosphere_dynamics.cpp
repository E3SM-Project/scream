...
void HommeDynamics::initialize_impl (const util::TimeStamp& /* t0 */)
{
  ...
  Kokkos::parallel_for(policy, KOKKOS_LAMBDA (const KT::MemberType& team) {
    ...
    Kokkos::parallel_for(Kokkos::TeamThreadRange(team,NVL),
      ...
      phinh_i(ie,nm1,igp,jgp,ilev) = phinh_i(ie,n0,igp,jgp,ilev)+500;
      phinh_i(ie,np1,igp,jgp,ilev) = phinh_i(ie,n0,igp,jgp,ilev)+500;
    });
    ...
    Kokkos::single(Kokkos::PerTeam(team),[&](){
      ...
      phinh_i(ie,nm1,igp,jgp,NVLI-1) = phinh_i(ie,n0,igp,jgp,NVLI-1)+500;
      phinh_i(ie,np1,igp,jgp,NVLI-1) = phinh_i(ie,n0,igp,jgp,NVLI-1)+500;
    });
