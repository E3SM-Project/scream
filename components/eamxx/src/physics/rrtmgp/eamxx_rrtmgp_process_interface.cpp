...
void RRTMGPRadiation::run_impl (const double dt) {
  ...
  if (update_rad) {
    ...
    for (int ic=0; ic<m_num_col_chunks; ++ic) {
      ...
      auto sw_flux_up_k      = subview_2dk(d_sw_flux_up);
      auto sw_flux_dn_k      = subview_2dk(d_sw_flux_dn);
      auto sw_flux_dn_dir_k  = subview_2dk(d_sw_flux_dn_dir);
      auto lw_flux_up_k      = subview_2dk(d_lw_flux_up);
      auto lw_flux_dn_k      = subview_2dk(d_lw_flux_dn);
      auto sw_clnclrsky_flux_up_k      = subview_2dk(d_sw_clnclrsky_flux_up);
      auto sw_clnclrsky_flux_dn_k      = subview_2dk(d_sw_clnclrsky_flux_dn);
      auto sw_clnclrsky_flux_dn_dir_k  = subview_2dk(d_sw_clnclrsky_flux_dn_dir);
      auto sw_clrsky_flux_up_k      = subview_2dk(d_sw_clrsky_flux_up);
      auto sw_clrsky_flux_dn_k      = subview_2dk(d_sw_clrsky_flux_dn);
      auto sw_clrsky_flux_dn_dir_k  = subview_2dk(d_sw_clrsky_flux_dn_dir);
      auto sw_clnsky_flux_up_k      = subview_2dk(d_sw_clnsky_flux_up);
      auto sw_clnsky_flux_dn_k      = subview_2dk(d_sw_clnsky_flux_dn);
      auto sw_clnsky_flux_dn_dir_k  = subview_2dk(d_sw_clnsky_flux_dn_dir);
      auto lw_clnclrsky_flux_up_k      = subview_2dk(d_lw_clnclrsky_flux_up);
      auto lw_clnclrsky_flux_dn_k      = subview_2dk(d_lw_clnclrsky_flux_dn);
      auto lw_clrsky_flux_up_k      = subview_2dk(d_lw_clrsky_flux_up);
      auto lw_clrsky_flux_dn_k      = subview_2dk(d_lw_clrsky_flux_dn);
      auto lw_clnsky_flux_up_k      = subview_2dk(d_lw_clnsky_flux_up);
      auto lw_clnsky_flux_dn_k      = subview_2dk(d_lw_clnsky_flux_dn);
