...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  subroutine atm_init_mct( EClock, cdata, x2a, a2x, NLFilename )
    ...
    use scream_f2c_mod,     only: scream_create_atm_instance, scream_setup_surface_coupling, &
                                  scream_init_atm
    use scream_cpl_indices, only: scream_set_cpl_indices, num_exports, num_imports, num_scream_imports, &
                                  scr_names_x2a, cpl_names_a2x, scr_names_a2x, index_x2a, index_a2x
    ...
    call scream_setup_surface_coupling (c_loc(scr_names_x2a), c_loc(index_x2a), c_loc(x2a%rAttr), num_imports, num_scream_imports, &
