...
// =========================================================================================
PotentialTemperatureDiagnostic2::PotentialTemperatureDiagnostic2 (const ekat::Comm& comm, const ekat::ParameterList& params)
...
// =========================================================================================
void PotentialTemperatureDiagnostic2::set_grids(const std::shared_ptr<const GridsManager> grids_manager)
{
...
// =========================================================================================
void PotentialTemperatureDiagnostic2::compute_diagnostic_impl()
{
  ...
  Kokkos::parallel_for("PotentialTemperatureDiagnostic2",
