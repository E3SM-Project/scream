...
void RelativeHumidityDiagnostic::compute_diagnostic_impl()
{
  ...
  Kokkos::parallel_for("RelativeHumidityDiagnostic",
      ...
      auto qv_sat_l = physics::qv_sat_dry(T_mid(icol,jpack), p_mid(icol,jpack), false, range_mask, physics::MurphyKoop, "RelativeHumidityDiagnostic::compute_diagnostic_impl");
