...
void HommeDynamics::set_grids (const std::shared_ptr<const GridsManager> grids_manager)
{
  ...
  auto pg_scalar3d_mid = m_phys_grid->get_3d_scalar_layout_mid();
  auto pg_scalar3d_int = m_phys_grid->get_3d_scalar_layout_int();
  auto pg_vector3d_mid = m_phys_grid->get_3d_vector_layout_mid(2);
  ...
  if (fv_phys_active()) {
    ...
    auto rg_scalar2d     = m_phys_grid->get_2d_scalar_layout();
    auto rg_scalar3d_mid = m_phys_grid->get_3d_scalar_layout_mid();
    auto rg_vector3d_mid = m_phys_grid->get_3d_vector_layout_mid(2);
