...
! Broadcast namelist variables
  ...
  !------------------------------------------------------------------- !  
    ...
    call addfld('SHOC_W21',(/'lev'/), 'A', 'm/s', 'St dev of w of first Gaussian')
    call addfld('SHOC_W22',(/'lev'/), 'A', 'm/s', 'St dev of w of second Gaussian')
    ...
    call addfld('SHOC_THL21',(/'lev'/), 'A', 'K', 'St dev of temperature of first Gaussian')
    call addfld('SHOC_THL22',(/'lev'/), 'A', 'K', 'St dev of temperature of second Gaussian')
    ...
    call addfld('SHOC_QW21',(/'lev'/), 'A', 'kg/kg', 'St dev of moisture of first Gaussian')
    call addfld('SHOC_QW22',(/'lev'/), 'A', 'kg/kg', 'St dev of moisture of second Gaussian')
  ...
  !------------------------------------------------------------------- !  
   ...
   real(r8) :: w1_1_out(pcols,pver), w1_2_out(pcols,pver)
   real(r8) :: w2_1_out(pcols,pver), w2_2_out(pcols,pver)
   real(r8) :: thl1_1_out(pcols,pver), thl1_2_out(pcols,pver)
   real(r8) :: thl2_1_out(pcols,pver), thl2_2_out(pcols,pver)
   real(r8) :: qw1_1_out(pcols,pver), qw1_2_out(pcols,pver)
   real(r8) :: qw2_1_out(pcols,pver), qw2_2_out(pcols,pver)
