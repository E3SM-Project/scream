...
protected:
  ...
  std::map<std::string,view_1d<Real>> fields_ext_1d;
  std::map<std::string,view_1d_host<Real>> fields_ext_1d_h;
  view_2d<Real> T_mid_ext;
  view_2d<Real> p_mid_ext;
  view_2d<Real> qv_ext;
  view_2d<Real> u_ext;
  view_2d<Real> v_ext;
  view_1d<Real> sfc_flux_dir_nir_ext;
  view_1d<Real> sfc_flux_dir_vis_ext;
  view_1d<Real> sfc_flux_dif_nir_ext;
  view_1d<Real> sfc_flux_dif_vis_ext;
  view_1d<Real> sfc_flux_sw_net_ext;
  view_1d<Real> sfc_flux_lw_dn_ext;
  TimeStamp ts0;
