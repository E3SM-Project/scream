...
template void Func::update_prognostics_implicit(
  ...
  const Func::scratch_view_1d<Spack>& tkh,
  ...
  const Func::scratch_view_2d<Spack>& wind_rhs_ks,
  const Func::scratch_view_2d<Spack>& qtracers_rhs_ks,
...
template void Func::update_prognostics_implicit(
  ...
  const Int&                          num_qtracers,
  const Func::Scalar&                 dtime,
  const Func::uview_1d<Spack>& dz_zt,
  const Func::uview_1d<Spack>& dz_zi,
  const Func::uview_1d<Spack>& rho_zt,
  const Func::uview_1d<const Spack>&  zt_grid,
  const Func::uview_1d<const Spack>&  zi_grid,
  const Func::uview_1d<const Spack>&  tk,
  const Func::uview_1d<Spack>&  tkh,
  const Func::Scalar&                 uw_sfc,
  const Func::Scalar&                 vw_sfc,
  const Func::Scalar&                 wthl_sfc,
  const Func::Scalar&                 wqw_sfc,
...
template void Func::update_prognostics_implicit(
  ...
  const Int&                          num_qtracers,
  const Func::Scalar&                 dtime,
  const Func::uview_1d<const Spack>& dz_zt,
  const Func::uview_1d<const Spack>& dz_zi,
  const Func::uview_1d<const Spack>& rho_zt,
  const Func::uview_1d<const Spack>&  zt_grid,
  const Func::uview_1d<const Spack>&  zi_grid,
  const Func::uview_1d<const Spack>&  tk,
