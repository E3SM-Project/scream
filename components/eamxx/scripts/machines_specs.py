...
MACHINE_METADATA = {
    ...
    "mappy"   : (["module purge", "module load sems-archive-env acme-env acme-gcc/12.3.0 sems-archive-cmake/3.19.1 sems-archive-git/2.10.1 acme-openmpi/4.0.7 acme-netcdf/4.9.2/acme"],
                 ["mpicxx","mpifort","mpicc"],
                  "",
