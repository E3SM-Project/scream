#ifndef SCREAM_PRESCRIBEDGASES_HPP
#define SCREAM_PRESCRIBEDGASES_HPP
...
public:
  ...
  // Constructors
  PrescribedGases (const ekat::Comm& comm, const ekat::ParameterList& params);

  // The type of subcomponent
  AtmosphereProcessType type () const { return AtmosphereProcessType::Physics; }

  // The name of the subcomponent
  std::string name () const { return "PrescribedGases"; }
...
protected:
  ...
  // Creates a helper field, not to be shared with the AD's FieldManager
  ...
  std::vector<std::string> m_fields_gases;
  ...
  Buffer m_buffer;
}; // class PrescribedGases

} // namespace scream

#endif // SCREAM_PRESCRIBEDGASES_HPP
