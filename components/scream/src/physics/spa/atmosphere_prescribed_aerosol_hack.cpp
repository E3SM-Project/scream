...
//  SPAPressureState.ps_this_month = get_field_in("PS_beg").get_view<Real*>();
//  SPAPressureState.ps_next_month = get_field_in("PS_end").get_view<Real*>();
  SPAPressureState.pmid          = get_field_in("p_mid").get_view<const Pack**>();

  SPAData_start.ncols       = m_num_cols;
  SPAData_start.nlevs       = m_num_levs;
  SPAData_end.ncols         = m_num_cols;
  SPAData_end.nlevs         = m_num_levs;
