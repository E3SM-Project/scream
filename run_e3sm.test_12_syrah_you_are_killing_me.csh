...
set my_npes        = 360
set job_name       = small_planet_RCE_SCREAM_3km_run_you_are_killing_me
...
cat <<EOF >> user_nl_cam
 ...
 do_clubb_sgs           =  .false.
 NHTFRQ = 240, 240
 fincl2 = 'TMQ:I','CLOUD:I','PRECL:I','U:I','V:I','OMEGA:I','Q:I','T:I','SHOC_MIX:I','CLDLIQ:I','CLDICE:I','CLDRIM','QRL:I','QRS:I','AQRAIN','vap_cld_exchange','vap_ice_exchange'
EOF
