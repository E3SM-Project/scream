...
!  integer,  parameter :: ncube = 540 !dimension of cubed-sphere grid
  ...
  !status = nf_open('gmted_bedmachine_stitched_landfract.nc', 0, ncid)
...
#     include         <netcdf.inc>
  ...
  !character(18), parameter :: grid_file_out = 'USGS-topo-cube3000.nc'
  ...
  !ncstat = nf_create (grid_file_out, nf_64bit_data,nc_grid_id)
