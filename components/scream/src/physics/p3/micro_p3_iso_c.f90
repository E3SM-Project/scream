...
subroutine  update_prognostic_ice_c(qcheti,qccol,qcshd,nccol,ncheti,ncshdc,qrcol,nrcol,qrheti,nrheti,nrshdr, &
  ...
  subroutine evap_precip_c(qr_incld, qc_incld, nr_incld, qitot_incld, lcldm, &
       rcldm, qvs, ab, epsr, qv, qrevp, nrevp) bind(C)
    use micro_p3, only: evap_precip
    ...
    call evap_precip(qr_incld, qc_incld, nr_incld, qitot_incld, lcldm, &
       rcldm, qvs, ab, epsr, qv, qrevp, nrevp)
  end subroutine evap_precip_c
