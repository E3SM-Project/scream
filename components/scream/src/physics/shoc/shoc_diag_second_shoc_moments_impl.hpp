       ...
       const uview_1d<Spack>& uw_sec, const uview_1d<Spack>& vw_sec, const uview_1d<Spack>& wtke_sec, const uview_1d<Spack>& w_sec)
{
  ...
  team.team_barrier();
  wthl_sec(nlevi_pack)[nlevi_indx]  = wthl_s;
  wqw_sec(nlevi_pack)[nlevi_indx]   = wqw_s;
  uw_sec(nlevi_pack)[nlevi_indx]    = uw_s;
  vw_sec(nlevi_pack)[nlevi_indx]    = vw_s;
  wtke_sec(nlevi_pack)[nlevi_indx]  = wtke_s;
  thl_sec(nlevi_pack)[nlevi_indx]   = thl_s;
  qw_sec(nlevi_pack)[nlevi_indx]    = qw_s;
  qwthl_sec(nlevi_pack)[nlevi_indx] = qwthl_s;
  ...
  thl_sec(0)[0]   = thl_s0;
  qw_sec(0)[0]    = qw_s0;
  wthl_sec(0)[0]  = wthl_s0;
  wqw_sec(0)[0]   = wqw_s0;
  qwthl_sec(0)[0] = qwthl_s0;
  uw_sec(0)[0]    = uw_s0;
  vw_sec(0)[0]    = vw_s0;
  wtke_sec(0)[0]  = wtke_s0;
}
