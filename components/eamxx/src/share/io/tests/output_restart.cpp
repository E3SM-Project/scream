...
get_test_fm(const std::shared_ptr<const AbstractGrid>& grid)
{
  ...
  auto scalar_1d = grid->get_vertical_layout_mid();
  auto scalar_2d = grid->get_2d_scalar_layout();
  auto scalar_3d = grid->get_3d_scalar_layout_mid();
  auto vector_3d = grid->get_3d_vector_layout_mid(2);
  auto rad_vector_3d = grid->get_3d_vector_layout_mid(3,"SWBND");
