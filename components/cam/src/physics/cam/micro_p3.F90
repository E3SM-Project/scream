 ...
 subroutine p3_main_part3(kts, kte, kbot, ktop, kdir, &
   ...
   k_loop_final_diagnostics:  do k = kbot,ktop,kdir
      ...
      if (qr(k).ge.qsmall) then
         ...
         !PMC potential bug: changed nr to nr_incld below. now ze is an in-cloud ze, while users
         !may be assuming ze is a cell-averaged thing.
      ...
      !PMC potential bug: I think *all* of this qi stuff needs to be incld!!!
      call impose_max_total_Ni(ni(k),max_total_Ni,inv_rho(k))
