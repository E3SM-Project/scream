...
//			Real *dcape, Real* q, Real** tend_s, Real** tend_q, Real** cld, 
//			Real* snow, Real* ntprprd, Real* ntsnprd, Real** flxprec, Real** flxsnow,
//			const Real& ztodt, Real* pguall, Real* pgdall, Real* icwu, const Real& ncnst );
//
void zm_main_f90(const Real& lchnk, const Real& ncol, Real* t, Real* qh, Real* prec,
			Real* jctop, Real* jcbot, Real* pblh, Real *zm, Real* geos, Real* zi,
			Real* qtnd, Real* heat, Real* pap, Real* paph, Real* dpp, const Real &delt,
			...
			Real** flxprec, Real** flxsnow 
			//Real* tm1, Real* qm1, Real** t_star, Real** q_star
			); 
//			Real* snow, Real* ntprprd, Real* ntsnprd, Real** flxprec, Real** flxsnow,
//			const Real& ztodt, Real* pguall, Real* pgdall, Real* icwu, const Real& ncnst);
