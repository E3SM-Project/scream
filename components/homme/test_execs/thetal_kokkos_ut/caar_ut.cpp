...
void run_caar_f90 (const int& nm1, const int& n0, const int& np1,
                   ...
                   const int& pgrad, const bool& hydrostatic,
                   const bool& adv_conservative, const int& rsplit,
      ...
      for (const bool hydrostatic : {true,false}) {
        ...
        for (const AdvectionForm adv_form : adv_forms) {
          ...
          for (int rsplit : {3,0}) {
            ...
            // Set the parameters
            params.pgrad_correction = bool(pgrad);
            ...
            run_caar_f90 (nm1+1, n0+1, np1+1, dt, eta_ave_w, scale1, scale2, scale3,
                          pgrad, hydrostatic,
                          adv_form==AdvectionForm::Conservative, rsplit,
