...
MACHINE_METADATA = {
    ...
    "pm-cpu" : (["module purge", "module use --append /global/cfs/cdirs/e3sm/eamxx-ml/install/install/modulefiles", "module load PrgEnv-gnu gcc-native/12.3 cray-libsci craype cray-mpich cray-hdf5-parallel cray-netcdf-hdf5parallel cray-parallel-netcdf cmake evp-patch cray-python/3.9.13.1 screamML-venv/0.0.1", "export LD_LIBRARY_PATH=/opt/cray/pe/python/3.9.13.1/lib:/global/common/software/nersc/pm-2022q4/sw/evp-patch/lib64:/opt/cray/libfabric/1.15.2.0/lib64:/usr/lib64/gcc/x86_64-suse-linux/12"],
                ["CC","ftn","cc"],
                "srun --time 00:30:00 -C cpu --nodes=1 -q regular",
                ""),        
