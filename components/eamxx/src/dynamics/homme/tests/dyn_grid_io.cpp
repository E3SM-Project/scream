...
TEST_CASE("dyn_grid_io")
{
  ...
  auto dyn_scalar3d_mid = dyn_grid->get_3d_scalar_layout_mid();
  auto dyn_vector3d_mid = dyn_grid->get_3d_vector_layout_mid(2);
  auto dyn_scalar2d     = dyn_grid->get_2d_scalar_layout();

  auto phys_scalar3d_mid = phys_grid->get_3d_scalar_layout_mid();
  auto phys_vector3d_mid = phys_grid->get_3d_vector_layout_mid(2);
